...
```
go install github.com/dezeroku/ses_local_email/s3_monitor@v0.5.2 #SED_RELEASE_VERSION
ses_local_email
```
...
```
go install github.com/dezeroku/ses_local_email_eml_unpack_attachments@v0.5.2 #SED_RELEASE_VERSION
ses_local_email
```
